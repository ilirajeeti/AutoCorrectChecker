...
{
    public partial class cSharpTest : Form
    {
        public cSharpTest()
        {
            InitializeComponent();
        ...
        {
            if(textBox1Test1.Text == "int" && textBox2Test1.Text =="myNum" && textBox3Test1.Text == "50")
            {
        ...
        {
            textBox1Test1.Text = "int";
            textBox2Test1.Text = "myNum";
            textBox3Test1.Text = "50";
        ...
        {
            if (textBox1Test2.Text == "string" && textBox2Test2.Text == "myName" && textBox3Test2.Text == "\"Burim\"")
            {
                panel1.BackColor = Color.FromArgb(0xD9, 0xEE, 0xE1);
        ...
        {
            textBox1Test2.Text = "string";
            textBox2Test2.Text = "myName";
            textBox3Test2.Text = "\"Burim\"";
        ...
        {
            if (textBox1Test3.Text == "int" && textBox2Test3.Text == "x" && textBox3Test3.Text == "5")
            {
                panel1.BackColor = Color.FromArgb(0xD9, 0xEE, 0xE1);
        ...
        {
            textBox1Test3.Text = "int";
            textBox2Test3.Text = "x";
            textBox3Test3.Text = "5";
        ...
        {
            if (textBox1Test4.Text == "int" && textBox2Test4.Text == "z" && textBox3Test4.Text == "z")
            {
                panel1.BackColor = Color.FromArgb(0xD9, 0xEE, 0xE1);
        ...
        {
            textBox1Test4.Text = "int";
            textBox2Test4.Text = "z";
            textBox3Test4.Text = "z";
        ...
        {
            if (textBox1Test5.Text == "int" && textBox2Test5.Text == "," && textBox3Test5.Text == ",")
            {
                panel1.BackColor = Color.FromArgb(0xD9, 0xEE, 0xE1);
